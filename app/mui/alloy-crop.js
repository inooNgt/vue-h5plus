...
(function() {
  var AlloyFinger =
    typeof require === "function" ? require("alloyfinger") : window.AlloyFinger;
  var Transform =
    typeof require === "function" ? require("css3transform") : window.Transform;
  ...
  AlloyCrop.prototype = {
    ...
    crop: function() {
      ...
      this.ctx.drawImage(
        ...
        0,
        0,
        this.crop_rect[2] * this.img.scaleX,
        this.crop_rect[3] * this.img.scaleY
      );
    },
    calculateRect: function() {
      ...
      var intersect_rect = this.getOverlap.apply(
        this,
        cover_rect.concat(img_rect)
      );
